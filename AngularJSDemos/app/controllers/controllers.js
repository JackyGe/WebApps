...
angular.module('customersApp').controller('OrdersController', function ($scope, customersService) {
    $scope.customers = [];
...
angular.module('customersApp').controller('NavbarController', function ($scope, $location) {
...
angular.module('customersApp').controller('OrderChildController', function ($scope) {
